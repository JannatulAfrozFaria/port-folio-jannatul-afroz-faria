                ...
                <div className="card-body text-justify order-2 md:order-1">
                    ...
                    <div>
                        <div className='grid grid-cols-4 md:grid-cols-8 gap-2 items-center w-4/5 md:w-5/6'>
                            <img className='w-16 rounded-lg' src="https://i.postimg.cc/ryJz3xZG/next-white.jpg" alt="Nxt.js" />
                            ...
                            {/* <img className='w-16 rounded-lg' src="https://i.postimg.cc/XJNfVxGs/node-js.png" alt="Node js" />
