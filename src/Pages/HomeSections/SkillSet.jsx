...
const SkillSet = () => {
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row gap-24 img_bg3 my-8 p-8 md:p-24 shadow-xl rounded-2xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
                    <div>
                        ...
                        <div className='grid grid-cols-3 gap-4'>
                            ...
                            {/* <img width={'50px'}  className='' src="https://i.ibb.co/09SwcH0/css-2.png" alt="CSS" /> */}
