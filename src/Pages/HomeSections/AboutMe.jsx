...
const AboutMe = () => {
  ...
  return (
    <div>
        ...
        <div data-aos="fade-right" data-aos-delay="1500" data-aos-duration="1500" className="img_bg_about_me grid grid-cols-1 md:grid-cols-2 gap-6 p-6 shadow-xl rounded-xl">
            <div data-aos="flip-up" data-aos-delay="2500" data-aos-duration="2500" className="w-full md:1/4">
            ...
            <div className="w-full md:w-3/4 mt-6">
                <h2 data-aos="fade-left" data-aos-delay="2000"  data-aos-duration="2000"className="card-title text-yellow-500 text-lg font-semibold">About Me</h2>
                <div data-aos="fade-left" data-aos-delay="2500" data-aos-duration="2000" className="mb-6 text-justify text-yellow-300">
                ...
                <div data-aos="fade-up" data-aos-delay="3000" data-aos-duration="1000"className="card-actions justify-start">
