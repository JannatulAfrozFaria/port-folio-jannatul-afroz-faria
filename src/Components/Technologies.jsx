    ...
    return (
        <div className="w-3/4 ">
            ...
            <div className='grid grid-cols-3 gap-2  items-center'>
                ...
                <img className='w-16 rounded-lg my-2' src="https://i.postimg.cc/XJNfVxGs/node-js.png" alt="Vercel" />
                <img className='w-16 h-16 rounded-lg my-2' src="https://i.ibb.co/MG8xR7v/express.jpg" alt="Express" />
                <img className='w-16 rounded-lg my-2' src="https://i.ibb.co/vJ9Cq7r/vercel.jpg" alt="Vercel" />
